...
export function AdminLayout({ children, title = "Dashboard", subtitle = "Welcome back to Delica Dental admin panel." }: AdminLayoutProps) {
  ...
  const navigationItems = [
    ...
    { href: "/admin/treatments", label: "Tratamientos", icon: Torus },
    { href: "/admin/images", label: "Imágenes", icon: Images },
